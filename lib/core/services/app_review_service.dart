...
class AppReviewService {
  ...
  /// Ouvre la fiche du store **sans rien prétendre sur un avis**.
  ///
  /// Chemin de la notice de mise à jour
  /// ([mise_a_jour_service.dart](mise_a_jour_service.dart)). Il ne peut pas
  /// passer par [ouvrirLaFicheDuStore], qui fait deux choses de plus, fausses
  /// ici : elle ouvre la page d'avis (`?action=write-review` sur iOS), et elle
  /// marque la fiche comme ouverte — ce qui couperait l'invitation automatique
  /// pour un avis que personne n'a déposé.
  ///
  /// Les liens, eux, restent ceux d'ici : ils ont déjà été faux une fois, et
  /// une troisième copie serait une troisième occasion.
  Future<bool> ouvrirLaFicheSansAvis() => _ouvrirDansLeNavigateur();
