...
///
/// Copied from [isMoneyTransferEnabled].
@ProviderFor(isMoneyTransferEnabled)
final isMoneyTransferEnabledProvider = AutoDisposeProvider<bool>.internal(
  isMoneyTransferEnabled,
  name: r'isMoneyTransferEnabledProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$isMoneyTransferEnabledHash,
  dependencies: null,
...
///
/// Copied from [isMarketplaceEnabled].
@ProviderFor(isMarketplaceEnabled)
final isMarketplaceEnabledProvider = AutoDisposeProvider<bool>.internal(
  isMarketplaceEnabled,
  name: r'isMarketplaceEnabledProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$isMarketplaceEnabledHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final isBusinessDirectoryEnabledProvider = AutoDisposeProvider<bool>.internal(
  isBusinessDirectoryEnabled,
  name: r'isBusinessDirectoryEnabledProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$isBusinessDirectoryEnabledHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
