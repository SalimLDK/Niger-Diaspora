...
| Maquette | Écran | Fichier `design_v2` | État |
|---|---|---|---|
| 10a | Mon profil | `profile/…/profile_screen.dart` | copié |
| 10c | Profil d'un membre (vue publique) | `profile/…/profile_view_screen.dart` | copié |
| 10b | Réglages | `settings/…/settings_screen.dart` | copié |
| 12c | Notifications | `notifications/…/notifications_screen.dart` | copié |
| 12d | Recherche | `search/…/search_screen.dart` | copié |
| 11f | Profil incomplet — invitation à compléter | — | à vérifier (bloc de `profile_screen`) |
