...
class RoomTicketModel extends Equatable {
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      'currency': currency,
      'status': status,
      'purchasedAt': purchasedAt ?? DateTime.now().toIso8601String(),
      'usedAt': usedAt,
      'stripePaymentIntentId': stripePaymentIntentId,
      'commissionAmount': commissionAmount,
      'sellerAmount': sellerAmount,
  ...
  RoomTicketEntity toEntity() {
    return RoomTicketEntity(
      ...
      purchasedAt: purchasedAt != null ? DateTime.parse(purchasedAt!) : DateTime.now(),
  ...
  static RoomTicketModel fromEntity(RoomTicketEntity entity) {
    return RoomTicketModel(
      ...
      usedAt: entity.usedAt?.toIso8601String(),
