  ...
  Future<void> _submitForm() async {
    ...
    try {
      final embassy = EmbassyModel(
        id: '', // Attribué par Supabase à l'insertion
      ...
      // Passe par le dépôt, donc par Supabase : créer dans Firestore
      // reviendrait à écrire dans une collection que plus personne ne lit.
      await ref
          .read(embassiesRepositoryProvider)
          .createEmbassy(embassy.toEntity());
