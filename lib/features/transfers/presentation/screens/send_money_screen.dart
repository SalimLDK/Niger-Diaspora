...
class _SendMoneyScreenState extends ConsumerState<SendMoneyScreen> {
  ...
  // (`#FA7D00`, `#E8DFD4`) et gardaient donc leur valeur de thème clair en
            ...
            if (transferState.exchangeRate != null) ...[
              ...
              Builder(
                builder: (context) {
                  ...
                  final border =
                      isDark
                          ? const Color(0xFF009600).withValues(alpha: 0.4)
                          : const Color(0xFFDCE6CE);
                  final amountColor =
                      isDark ? const Color(0xFF32E252) : const Color(0xFF009600);
                  return Container(
