...
abstract class $GroupInviteModelCopyWith<$Res> {
  factory $GroupInviteModelCopyWith(
    GroupInviteModel value,
    $Res Function(GroupInviteModel) then,
...
abstract class _$$GroupInviteModelImplCopyWith<$Res>
    implements $GroupInviteModelCopyWith<$Res> {
  factory _$$GroupInviteModelImplCopyWith(
    _$GroupInviteModelImpl value,
...
class __$$GroupInviteModelImplCopyWithImpl<$Res>
  ...
  __$$GroupInviteModelImplCopyWithImpl(
    _$GroupInviteModelImpl _value,
...
/// @nodoc
@JsonSerializable()
class _$GroupInviteModelImpl extends _GroupInviteModel {
  const _$GroupInviteModelImpl({
    required this.id,
  ...
  @override
  String toString() {
    return 'GroupInviteModel(id: $id, groupId: $groupId, groupName: $groupName, groupImageUrl: $groupImageUrl, inviterId: $inviterId, inviterName: $inviterName, inviteeId: $inviteeId, inviteeName: $inviteeName, inviteePhotoUrl: $inviteePhotoUrl, status: $status, createdAt: $createdAt, respondedAt: $respondedAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$GroupInviteModelImplToJson(this);
  }
}

abstract class _GroupInviteModel extends GroupInviteModel {
  const factory _GroupInviteModel({
