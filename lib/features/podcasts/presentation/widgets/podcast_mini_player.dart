              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Stack(
                      children: [
                        ClipRRect(
                          ...
                          child: _buildThumbnail(episode, playerState.coverUrl),
                        ),
                    ...
                    // Close button
                    IconButton(
                      icon: const AppIcon(AppIcon.close, color: Colors.grey, size: 20),
                      onPressed: () {
...
Widget _buildThumbnail(episode, String? coverUrl) {
  ...
  if (imageUrl != null) {
    return CachedNetworkImage(
      ...
      placeholder: (_, __) => Container(
        ...
        child: const AppIcon(AppIcon.podcasts, color: Colors.grey),
      ),
