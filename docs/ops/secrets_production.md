...
| `MYNITA_API_KEY`, `WAVE_API_KEY`, `VISA_DIRECT_API_KEY`, `MASTERCARD_SEND_API_KEY` | **absentes** | Les clients de paiement partenaires tournent avec des identifiants vides. |
